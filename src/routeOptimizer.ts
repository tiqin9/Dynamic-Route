 ...
 */
export function calculateTotalTime(stops: Stop[]): number {
 ...
 */
export function optimizeRouteNearestNeighbor(stops: Stop[]): Stop[] {
 ...
 */
export function optimizeRoute2Opt(stops: Stop[], iterations: number = 100): Stop[] {
  let bestRoute = [...stops];
